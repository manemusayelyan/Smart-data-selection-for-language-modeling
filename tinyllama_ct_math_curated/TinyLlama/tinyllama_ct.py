...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--train_data_dir", type=str, default="/mnt/weka/mmusayelyan/data/prep_hkmeans_owm_3.63M")
    p.add_argument("--out_dir", type=str, default="/mnt/weka/mmusayelyan/tinyllama_ct_clustered")
    ...
    p.add_argument("--stable_steps", type=int, default=6560)
