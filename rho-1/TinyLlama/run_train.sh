...
#SBATCH --nodes=1
#SBATCH --job-name=rho_1
#SBATCH --ntasks-per-node=1
#SBATCH --gpus-per-node=8
#SBATCH --cpus-per-task=64
#SBATCH --mem=200G
#SBATCH --time=24:00:00
#SBATCH --output=/mnt/weka/mmusayelyan/logs/%x-%j.out
#SBATCH --error=/mnt/weka/mmusayelyan/logs/%x-%j.err
...
"$ENVPY" -m torch.distributed.run \
  ...
  --reference_checkpoint_dir=/mnt/weka/mmusayelyan/tinyllama_ct_exp2/step-13952 \
  --train_data_dir=/mnt/weka/mmusayelyan/data/prep_datasets/owm \
  --out_dir=/mnt/weka/mmusayelyan/rho-1_2.0 \
