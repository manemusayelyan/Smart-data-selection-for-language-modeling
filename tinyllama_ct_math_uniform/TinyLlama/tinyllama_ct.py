...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--train_data_dir", type=str, default="/mnt/weka/mmusayelyan/data/prep_owm_uniform_3.91M")
    p.add_argument("--out_dir", type=str, default="/mnt/weka/mmusayelyan/tinyllama_ct_math_uniform")
    ...
    p.add_argument("--stable_steps", type=int, default=8000)
    p.add_argument("--max_steps", type=int, default=8576)

    p.add_argument("--log_interval", type=int, default=10)
    p.add_argument("--save_interval", type=int, default=4288)
