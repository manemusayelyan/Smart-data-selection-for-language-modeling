...
def prepare_full(process_id, num_processes, tokenizer_path, destination_path, chunk_size):
    ...
    dataset = load_from_disk(
        "/mnt/weka/mmusayelyan/data/owm_uniform_3.91M/owm_uniform_3.91M/"
...
if __name__ == "__main__":
    ...
    prepare(
        tokenizer_path=Path("/mnt/weka/mmusayelyan/tinyllama_checkpoints/TinyLlama-1.1B-intermediate-step-1431k-3T"),
        destination_path=Path("/mnt/weka/mmusayelyan/data/prep_owm_uniform_3.91M")
    )