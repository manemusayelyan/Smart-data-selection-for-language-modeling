...
#SBATCH --nodes=1
#SBATCH --job-name=tinyllama_ct_uniform_14B_exp
#SBATCH --ntasks-per-node=1
#SBATCH --gpus-per-node=8
#SBATCH --cpus-per-task=64
#SBATCH --mem=200G
#SBATCH --time=24:00:00
#SBATCH --output=/home/mmusayelyan/tinyllama_ct_math_uniform/%x-%j.out
#SBATCH --error=/home/mmusayelyan/tinyllama_ct_math_uniform/%x-%j.err

set -euo pipefail

ENVDIR=/mnt/weka/mmusayelyan/conda_envs/tinyllama_ct
ENVPY=$ENVDIR/bin/python
PROJECT_DIR=/home/mmusayelyan/tinyllama_ct_math_uniform/TinyLlama
...
"$ENVPY" -m torch.distributed.run \
  ...
  --nproc_per_node=8 \
  tinyllama_ct.py \
  --out_dir=/mnt/weka/mmusayelyan/tinyllama_ct_uniform_14B_exp \
  --max_steps 13952 \
  --warmup_steps 300 \
  --stable_steps 10862 \
  --save_interval 6976